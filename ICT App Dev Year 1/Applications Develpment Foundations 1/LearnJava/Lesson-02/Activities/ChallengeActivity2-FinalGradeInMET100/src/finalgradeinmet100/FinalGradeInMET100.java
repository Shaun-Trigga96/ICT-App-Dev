...
public class FinalGradeInMET100 {
    ...
    public static void main(String[] args) {
       // TODO: Write solution here.
        int exam1, exam2, exam3, totPoint, Perc;
        
        Scanner input = new Scanner(System.in);
        
        System.out.print("Exam 1 Score is: ");
        exam1 = input.nextInt();
       
        System.out.print("Exam 2 Score is: ");
        exam2 = input.nextInt();
        
        System.out.print("Exam 3 Score is: ");
         exam3 = input.nextInt();
        
         totPoint = exam1 + exam2+ exam3;
          
        System.out.print("Total Point: %d\n", total);
        
         Perc = 100 *totPoint / 450;
